{ config, pkgs, lib, ... }: let
  sources = {
    ...
    napcat_version = "v2.6.24";
    napcat_url = "https://github.com/NapNeko/NapCatQQ/releases/download/v2.6.24/NapCat.Shell.zip";
    napcat_hash = "sha256-rHmDONTLDOHtIH0PvkJGRylkWFHJMAW+PiMAPOxHAjc=";
