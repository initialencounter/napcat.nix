{ config, pkgs, lib, ... }: let
  sources = {
    ...
    napcat_version = "v4.2.9";
    napcat_url = "https://github.com/NapNeko/NapCatQQ/releases/download/v4.2.9/NapCat.Shell.zip";
    napcat_hash = "sha256-WiGZWhdvVNaUX0KlkBkxHJIobsJo7H3s6Mrn12w39UM=";
