{ config, pkgs, lib, ... }: let
  sources = {
    ...
    napcat_version = "v4.7.19";
    napcat_url = "https://github.com/NapNeko/NapCatQQ/releases/download/v4.7.19/NapCat.Shell.zip";
    napcat_hash = "sha256-/0CU21FUZwgtmcbK83acFAzlu6mXcsLmLIYEhZIBH1M=";
  ...
  patched = pkgs.qq.overrideAttrs (old: {
    ...
    version = "${sources.qq_version}-NapCat-${sources.qq_version}";
    inherit src;
    postFixup = ''
      mkdir -p $out/napcat
