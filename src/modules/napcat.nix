{ config, pkgs, lib, ... }: let
  sources = {
    ...
    napcat_version = "v3.2.12";
    napcat_url = "https://github.com/NapNeko/NapCatQQ/releases/download/v3.2.12/NapCat.Shell.zip";
    napcat_hash = "sha256-pmUEAQDCOhanZQF25TnrB2px6Lm0sdDhFdOZjjAF1Sc=";
